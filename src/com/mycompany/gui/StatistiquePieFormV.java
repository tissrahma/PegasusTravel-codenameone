 ...
 * @author 21695
 */
public class StatistiquePieFormV extends Form {
 
       
    private boolean drawOnMutableImage;
   
   
    private double nbr_reservation = 0.1;
    private double nbr_voyage = 0.8;
   
    Form current;
     Form form;
        public StatistiquePieFormV(Resources res)  {
